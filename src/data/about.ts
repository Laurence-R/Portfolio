...
export const aboutContent: AboutContent = {
  intro: [
    ...
    "目前主要專注在 Fast-CLAHE 百萬專題，以及持續維護中的 Star Dream Nails。也曾在 GDG on Campus NCUE 擔任前端講師。課外曾擔任迎新總召，並代表學校取得大專撞球錦標賽團體賽第三名。",
  ],
  skills: [
    "Next.js",
    "React",
  ...
  featuredFocus: {
    ...
    highlights: [
      ...
      "處理 1200x800 解析度影像的 P99 延遲僅約 2.39 ms，可即時部署",
    ],
